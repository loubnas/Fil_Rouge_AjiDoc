...
@Component({
  selector: 'app-liste-mo',
  templateUrl: './liste-mo.component.html',
  styleUrls: ['./liste-mo.component.css']
})
export class ListeMoComponent implements OnInit,AfterContentInit {
  ...
  public selectedMO:MedicalOffice={};

  public addModal:any;
  public updateModal:any;
  public deleteModal:any;

  constructor(private userService:UserService,private medicalService:MedicalOfficeService) { }
  ...
  update(ms:MedicalOffice){
   
    ms.administrator={id:SessionVariables.connectedUser.id};
      this.medicalService.update(ms).subscribe(data=>{
        //update
  ...
  add(mo:MedicalOffice){
   
    mo.administrator={id:SessionVariables.connectedUser.id};
     console.log("MO",mo);
      this.medicalService.add(mo).subscribe(data=>{
        //update
        this.userService.getById(SessionVariables.connectedUser?.id).subscribe(data=>{
  ...
  delete(user:User){
    var ms:MedicalOffice={
      id:user.id,
    }
    console.log(user);
    this.medicalService.delete(ms.id!).subscribe(data=>{
